...
namespace CVNetControls
{
	...
	public ref class TitledLabelTitledList : public ControlTitledList<TitledLabel>
	{
		public:
		...
		#pragma endregion
			...
			TitledLabelTitledList() : ControlTitledList<TitledLabel>() {}
			TitledLabelTitledList(Control^ parent) : ControlTitledList<TitledLabel>(parent) {}
