...
namespace CVNetControls
{
	...
	public ref class LabelButtonList : public ControlSingleList<LabelButton>
	{
		public:
		...
		#pragma endregion
			...
			LabelButtonList() : ControlSingleList<LabelButton>() {}
			LabelButtonList(Control^ parent) : ControlSingleList<LabelButton>(parent) {}
