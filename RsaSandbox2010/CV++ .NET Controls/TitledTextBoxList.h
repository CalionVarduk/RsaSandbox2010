...
namespace CVNetControls
{
	...
	public ref class TitledTextBoxList : public ControlSingleList<TitledTextBox>
	{
		public:
		...
		#pragma endregion
			...
			TitledTextBoxList() : ControlSingleList<TitledTextBox>() {}
			TitledTextBoxList(Control^ parent) : ControlSingleList<TitledTextBox>(parent) {}
